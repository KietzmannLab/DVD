...
#     # add by zejin
#     '''
#     # default imagenet transforms with normalize    
#     RandomResizedCrop(size=(224, 224), scale=(0.08, 1.0), ratio=(0.75, 1.3333), interpolation=bilinear, antialias=warn)
#     RandomHorizontalFlip(p=0.5)
#     ColorJitter(brightness=(0.9, 1.1), contrast=(0.9, 1.1), saturation=(0.9, 1.1), hue=None)
#     ToTensor()
#     <robustness.data_augmentation.Lighting object at 0x1467c1b78430>
...
#     # Add ToTensor first, unlike ecoset dataset loader default in tensor format
#     # custom_dataset.transform_train.transforms.append(transforms.ToTensor())

#     # import pdb; pdb.set_trace();
#     if train_transforms.transforms and len(train_transforms.transforms) >= 1:
#     #* Clean the previous default image transforms, using our own transforms    
#         custom_dataset.transform_train.transforms = []
#         for train_transfrom in train_transforms.transforms:
#             custom_dataset.transform_train.transforms.append(train_transfrom)
#     if test_transforms and len(test_transforms.transforms) >= 1:
#         custom_dataset.transform_test.transforms = []
#         for test_transfrom in test_transforms.transforms:
#             custom_dataset.transform_test.transforms.append(test_transfrom)
