...
class EarlyVisualDevelopmentTransformer:
    ...
    def apply_fft_transformations(self, image, age_months, apply_blur=1, apply_color=1, apply_contrast=1, contrast_threshold =0.2, apply_threshold_color = False, image_size= 224, verbose=False):
        ...
        def process_image(image):
            ...
            # Color
            if apply_color:
                chromatic_sensitivity = self.get_color_sensitivity(age_months)
