...
def get_blur_loader(sigma: int, args) -> DataLoader:
    ...
    Expects hyp['dataset']['name'] in {'texture2shape_miniecoset','facescrub'}
    and HDF5 files named accordingly under your robustness_datasets folder.
    """
    image_size = 256
    ds_name = args.dataset_name
    if ds_name == 'texture2shape_miniecoset':
        base = "/home/student/l/lzejin/codebase/P001_evd_gpus/data/robustness_datasets/degradation_images_generator/data/miniecoset/blurred/"
        split = 'test'
        fname = f"texture2shape_miniecoset_{image_size}px_sigma_{sigma}_blurred.h5"
    elif ds_name == 'ecoset_square256':
        base = "/home/student/l/lzejin/codebase/P001_evd_gpus/data/robustness_datasets/degradation_images_generator/data/objects_blurred_datasets/"
        split = 'test'
        fname = f"ecoset_{image_size}px_sigma_{sigma}_blurred.h5"
    elif ds_name == 'facescrub':
        base = "/home/student/l/lzejin/codebase/P001_evd_gpus/data/robustness_datasets/degradation_images_generator/data/faces_blurred_datasets/"
        split = 'test'
...
class SupervisedLearningDataset:
    ...
    def get_supervised_pipeline_transform(self, 
        ...
        # 2) Resize to 224x224 or 256x256 if specified in hyp
        aug_list.append(K.Resize((256, 256)))
    ...
    def _get_skeleton_ayzenberg(self) -> Dict[str, torch.utils.data.Dataset]:
        image_size = 256
        data_path = "/home/student/l/lzejin/codebase/P001_evd_gpus/data/skeleton_ayzenberg/original/"  # change as appropriate
