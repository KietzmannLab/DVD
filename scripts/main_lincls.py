...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # if cfg.dataset_identifer == "ecoset_square256":
    #     out_dim = 565
    # elif "texture2shape_miniecoset" in cfg.dataset_identifer:
    #     out_dim = 112
    ...
    dataset = SupervisedLearningDataset('/share/klab/datasets') # 2 view
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if not args.multiprocessing_distributed or (args.multiprocessing_distributed
            ...
            }, is_best, filename='lincls_checkpoint_{}.pth'.format(epoch), save_dir=f'checkpoints/{args.saving_name}')
...
def save_checkpoint(state, is_best, filename='checkpoint.pth',  save_dir='checkpoints'):
