...
class EarlyVisualDevelopmentTransformer:
    ...
    def apply_fft_transformations(self, image, apply_blur, apply_color, apply_contrast, age_months, contrast_threshold_alpha =1, cs_age50=4.8*12, image_size= 224, verbose=False, speed_ctrl=None):
        ...
        def process_image(image):
            ...
            if apply_blur:
                ...
                if blur_sigma > 0:
                    ...
                    # Kornia’s GPU-based blur instead of F.gaussian_blur
            ...
            if apply_contrast:
                ...
                threshold = max_power* 0.001 * (1 - contrast_sensitivity) * contrast_threshold_alpha # contrast_threshold_alpha higher lower,  to control the speed of contrast drop speed, since it filters out the high frequency more
                ...
                image = filtered_image.clip(0, 1)
        
            return image 

        # If the input is a list, process each image individually, e.g for contrastive learning
